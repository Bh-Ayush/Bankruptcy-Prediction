...
## Sources & Citations
- Polish Companies Bankruptcy Dataset (UCI): Zikeba et al. (2016). [link](https://archive.ics.uci.edu/ml/datasets/Polish+companies+bankruptcy+data)
- Taiwanese Bankruptcy Dataset (UCI/Kaggle): Yeh & Lien (2009). [link](https://archive.ics.uci.edu/ml/datasets/Taiwanese+Bankruptcy+Prediction)
- American Companies Bankruptcy Dataset (Kaggle): Kaggle Dataset (2019). [link](https://www.kaggle.com/datasets/utkarshx27/american-companies-bankruptcy-prediction-dataset)
